...
const APIDataViewer = ({ stations }) => {
  ...
  const copyToClipboard = () => {
    ...
    const jsonData = viewMode === 'ngsi-ld' 
    ...
    <div className="api-data-viewer">
      <div className="api-header">
        ...
        <p className="api-description">
          Dữ liệu từ các trạm giám sát được chuẩn hóa theo NGSI-LD Context Information Management,
          tương thích với nền tảng FIWARE cho thành phố thông minh.
        </p>
      </div>
          ...
          <div className="station-list">
            {stations.map((station) => (
              ...
              >
                ...
                <div className="station-aqi">AQI: {Math.round(station.aqi)}</div>
              </button>
            ))}
          </div>
        </div>
        ...
        {selectedStation && (
          <div className="data-display">
            <div className="data-controls">
              ...
              <button
                className={`view-toggle ${viewMode === 'ngsi-ld' ? 'active' : ''}`}
                ...
                <table className="data-table">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{selectedStation.location.lat}, {selectedStation.location.lng}</td>
                    </tr>
                    <tr>
                      <td><strong>AQI:</strong></td>
                      <td className="aqi-value">{Math.round(selectedStation.aqi)}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>{new Date(selectedStation.timestamp).toLocaleString('vi-VN')}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="api-info">
              <h4>📘 About NGSI-LD</h4>
              <p>
                <strong>NGSI-LD</strong> is a standardized API for context information management 
                in IoT and smart city systems. Developed by ETSI and widely used in the FIWARE platform.
              </p>
              <ul>
